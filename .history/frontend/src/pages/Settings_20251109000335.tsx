...
const Settings: FC = () => {
  ...
  const handleSendReport = async (
    type: "daily-report" | "stock-alert" | "attendance" | "revenue-alert"
  ) => {
    ...
    try {
      const endpoints: Record<string, string> = {
        ...
        "revenue-alert": "/settings/send-revenue-alert-now",
      };
          ...
          <Grid item xs={12}>
            ...
            >
              ...
              <Switch
                ...
                onChange={(e) =>
                  handleInputChange("dailyEmailEnabled", e.target.checked)
                }
              />
            </Stack>
          </Grid>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4, borderRadius: 3 }}>
        ...
        <Grid container spacing={2}>
          {[
            ...
            { label: "Send Revenue Alert", color: "error", type: "revenue-alert" },
          ].map((btn) => (
            <Grid item xs={12} sm={6} md={4} key={btn.type}>
              <Button
                ...
                onClick={() =>
                  handleSendReport(
                    btn.type as "daily-report" | "stock-alert" | "attendance" | "revenue-alert"
                  )
                }
