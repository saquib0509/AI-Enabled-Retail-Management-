    ...
    <Box sx={{ p: 4, background: "#f8f9fb", minHeight: "100vh" }}>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4, borderRadius: 3 }}>
        ...
        <Grid container spacing={2}>
          {[
            {
              label: "📊 Daily Report NOW",
              color: "success",
              type: "daily-report",
              desc: "Revenue, Sales, Attendance",
            },
            {
              label: "📦 Stock Alert NOW",
              color: "warning",
              type: "stock-alert",
              desc: "Critical & Warning Alerts",
            },
            {
      ...
      <Typography
        variant="caption"
        sx={{ color: "gray", display: "block", textAlign: "center", mt: 2 }}
      >
        ⚡ All changes are automatically saved to your backend.
      </Typography>
    </Box>
  );
};
