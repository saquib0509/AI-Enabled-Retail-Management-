import { Drawer, Toolbar, Box, Typography, List, ListItemButton, ListItemIcon, ListItemText, Avatar, Divider } from '@mui/material';
  ...
  const drawerContent = (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', p: 2, pb: 3 }}>
        <Avatar alt="Admin User" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" sx={{ width: 40, height: 40, mr: 1.5 }} />
        <Box>
          <Typography fontWeight={600} fontSize={15}>Admin User</Typography>
          <Typography color="text.secondary" fontSize={13} noWrap width={130}>admin@example.com</Typography>
        </Box>
      </Box>
    </Box>
  );
